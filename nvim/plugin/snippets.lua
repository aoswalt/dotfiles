...
ls.add_snippets(nil, {
  ...
  elixir = {
    ...
    s('defp', fmt('defp {}({}) do\n	{}\nend', { i(1, 'function'), i(2), i(0) })),
    s('defmo', fmt('defmodule {} do\n	{}\nend', { i(1, 'Module'), i(0) })),
    s('defmop', fmt('defmodulep {} do\n	{}\nend', { i(1, 'Module'), i(0) })),
    s('ins', fmt('IO.inspect({}, label: "{}")', { i(1), dl(2, l._1, 1) })),
    s('doc', fmt('@doc """\n{}\n"""', i(0))),
    s('docf', t('@doc false')),
    s('mdoc', fmt('@moduledoc """\n{}\n"""', i(0))),
  ...
  markdown = {
    ...
    ls.parser.parse_snippet(
      'imgl',
      [[[![${2:Alt Text}](${1:./path/to/img.png} "${3:Title}")](${4:./link/location})$0]]
    ), -- image link
    s(
      { trig = 'p(%d+)', name = 'page', regTrig = true },
      f(function(_args, snip)
        return '(p. ' .. snip.captures[1] .. ')'
      end, {}) -- luacheck: no unused
    ),

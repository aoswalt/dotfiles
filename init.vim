...
command! -nargs=* VTerm :vsp|execute 'terminal' <args>|set bufhidden=hide
command! -nargs=* VTermRepo :vsp|execute 'lcd' fnameescape(s:get_git_root())|execute 'terminal' <args>|set bufhidden=hide
command! -nargs=* STerm :sp|execute 'terminal' <args>|set bufhidden=hide
command! -nargs=* STermRepo :sp|execute 'lcd' fnameescape(s:get_git_root())|execute 'terminal' <args>|set bufhidden=hide
command! -nargs=* TTerm :tabnew|execute 'terminal' <args>|set bufhidden=hide
command! -nargs=* TTermRepo :tabnew|execute 'lcd' fnameescape(s:get_git_root())|execute 'terminal' <args>|set bufhidden=hide
